...
namespace Crosstales.BWF.EditorUtil
{
   ...
   public abstract class EditorHelper : Common.EditorUtil.BaseEditorHelper
   {
      ...
      {
         get { return loadImage(ref icon_contains, "icon_contains.png"); }
      }

      public static Texture2D Icon_Get
      {
         get { return loadImage(ref icon_get, "icon_get.png"); }
      }

      public static Texture2D Icon_Replace
      {
         get { return loadImage(ref icon_replace, "icon_replace.png"); }
      }

      public static Texture2D Icon_Mark
      {
         get { return loadImage(ref icon_mark, "icon_mark.png"); }
      }
      ...
      {
         get { return GameObject.Find(Util.Constants.MANAGER_SCENE_OBJECT_NAME) != null; }
      }
