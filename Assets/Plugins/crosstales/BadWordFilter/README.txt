...
Please install "Assets/Plugins/crosstales/Common/UI.unitypackage" first and afterwards "Demo.unitypackage" to use the demo scene!
...
### Demo
* [WebGL-Demo](https://www.crosstales.com/media/data/assets/badwordfilter/webgl/)
