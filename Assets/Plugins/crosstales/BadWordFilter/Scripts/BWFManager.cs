...
namespace Crosstales.BWF
{
   ...
   public class BWFManager : MonoBehaviour
   {
      ...
      {
         get { return Manager.BadWordManager.isReady && Manager.DomainManager.isReady && Manager.CapitalizationManager.isReady && Manager.PunctuationManager.isReady; }
      }
      ...
      private static void onBWFReady()
      {
         if (_onBWFReady != null)
         {
            _onBWFReady();
