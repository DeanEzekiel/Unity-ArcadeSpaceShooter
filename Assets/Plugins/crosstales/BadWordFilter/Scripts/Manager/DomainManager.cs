...
namespace Crosstales.BWF.Manager
{
   ...
   public class DomainManager : BaseManager
   {
      ...
      [Header("Specific Settings")] [Tooltip("Replace characters for domains (default: *).")] public string ReplaceChars = "*"; //e.g. "?#@*&%!$^~+-/<>:;=()[]{}"


      /// <summary>List of all domain providers.</summary>
      [Header("Domain Providers")] [Tooltip("List of all domain providers.")] public System.Collections.Generic.List<Provider.DomainProvider> DomainProvider;
