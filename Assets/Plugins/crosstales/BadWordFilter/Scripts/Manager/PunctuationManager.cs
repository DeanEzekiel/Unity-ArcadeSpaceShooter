...
namespace Crosstales.BWF.Manager
{
   ...
   public class PunctuationManager : BaseManager
   {
      ...
      [Header("Specific Settings")] [Tooltip("Defines the number of allowed punctuation letters in a row (default: 3).")]
      ...
      public static int CharacterNumber
      {
         get
         {
            ...
            return instance != null ? instance.PunctuationCharsNumber : 3;
         }
