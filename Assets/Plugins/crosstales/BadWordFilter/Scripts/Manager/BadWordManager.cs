...
namespace Crosstales.BWF.Manager
{
   ...
   public class BadWordManager : BaseManager
   {
      ...
      [Header("Specific Settings")] [Tooltip("Replace characters for bad words (default: *).")] public string ReplaceChars = "*"; //e.g. "?#@*&%!$^~+-/<>:;=()[]{}"

      /// <summary>Replace Leet speak in the input string (default: false).</summary>
      [Tooltip("Replace Leet speak in the input string (default: false).")] public bool ReplaceLeetSpeak = false;
      ...
      [Header("Bad Word Providers")] [Tooltip("List of all left-to-right providers.")] public System.Collections.Generic.List<Provider.BadWordProvider> BadWordProviderLTR;

      /// <summary>List of all right-to-left providers.</summary>
      [Tooltip("List of all right-to-left providers.")] public System.Collections.Generic.List<Provider.BadWordProvider> BadWordProviderRTL;
      ...
      public static string ReplaceCharacters
      {
         get
         {
            ...
            return instance != null ? instance.ReplaceChars : "*";
         }
      ...
      public static bool isReplaceLeetSpeak
      {
         get
         {
            ...
            return instance != null && instance.ReplaceLeetSpeak;
         }
      ...
      public static bool isSimpleCheck
      {
         get
         {
            ...
            return instance != null && instance.SimpleCheck;
         }
      ...
      public static int TotalRegexCount
      {
         get { return Enumerable.Sum(Sources, src => src.RegexCount); }
      }
         ...
         else
         {
            if (!Util.Helper.isEditorMode && DontDestroy && instance != this)
            {
               if (!loggedOnlyOneInstance)
               {
                  ...
                  Debug.LogWarning("Only one active instance of '" + clazz + "' allowed in all scenes!" + System.Environment.NewLine + "This object will now be destroyed.", this);
               }
