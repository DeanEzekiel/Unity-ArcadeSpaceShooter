namespace Crosstales.BWF.Util
{
   ...
   public abstract class Constants : Common.Util.BaseConstants
   {
      ...
      public const string ASSET_VERSION = "2020.1.8";

      /// <summary>Build number of the asset.</summary>
      public const int ASSET_BUILD = 20200618;
      ...
      public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2020, 6, 18);
